...
export declare class ChunkManager {
     ...
     */
    static configure(config: ChunkManagerConfig): void;
    /**
     ...
     * or reuse previously downloaded one.
     */
    static resolveChunk(chunkId: string, parentChunkId?: string): Promise<import("./types").ChunkConfig>;
    /**
     ...
     */
    static loadChunk(chunkId: string, parentChunkId?: string): Promise<void>;
    /**
     ...
     * @param chunkId Id of the chunk.
     */
    static preloadChunk(chunkId: string): Promise<void>;
    /**
     ...
     */
    static invalidateChunks(chunksIds?: string[]): Promise<void>;
}
