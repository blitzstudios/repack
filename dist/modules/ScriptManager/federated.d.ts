...
export declare namespace Federated {
     ...
     */
    type URLResolver = (scriptId: string, caller?: string) => string | ((webpackContext: RepackRuntimeGlobals.WebpackRequire) => string) | undefined;
    /**
     * @deprecated
     *
     ...
     */
    function createURLResolver(config: Federated.URLResolverConfig, containerExt?: string): Federated.URLResolver;
    /**
     * @deprecated
     *
     ...
     * ```
     */
    function importModule<Exports = any>(containerName: string, module: string, scope?: string, force?: boolean): Promise<Exports>;
}
