...
import type { ScriptLocatorResolver, StorageApi } from './types.js';
...
export declare class ScriptManager extends EventEmitter {
     ...
     * @param caller Name of the calling script - it can be for example: name of the bundle, chunk or container.
     */
    prefetchScript(scriptId: string, caller?: string, webpackContext?: RepackRuntimeGlobals.WebpackRequire): Promise<void>;
    /**
