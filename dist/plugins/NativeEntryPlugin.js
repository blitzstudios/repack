...
class NativeEntryPlugin {
  ...
  apply(compiler) {
    ...
    const nativeEntries = [...getReactNativePolyfills(), initializeCorePath, initializeScriptManagerPath, includeModulesPath];
