...
type ModuleFederationPluginOptions = typeof container.ModuleFederationPluginV1 extends {
    new (options: infer O): InstanceType<typeof container.ModuleFederationPluginV1>;
} ? O : never;
/**
