...
const FLOW_TYPED_MODULES_LOADING_RULES = exports.FLOW_TYPED_MODULES_LOADING_RULES = {
  ...
  test: /\.jsx?$/,
  include: (0, _utils.getModulePaths)(['react-native-blob-util', 'react-native-pdf', '@react-native-picker/picker', 'react-native-config', 'react-native-fs', 'react-native-image-size', 'react-native-performance', 'react-native-vector-icons', '@react-native-community/datetimepicker']),
  use: {
