  ...
  apply(compiler) {
    ...
    compiler.hooks.compilation.tap('RepackTargetPlugin', compilation => {
      compilation.hooks.additionalTreeRuntimeRequirements.tap('RepackTargetPlugin', (chunk, runtimeRequirements) => {
        ...
        compilation.addRuntimeModule(chunk, new _RepackInitRuntimeModule.RepackInitRuntimeModule(chunk.id ?? undefined, globalObject, compiler.options.output.chunkLoadingGlobal));
