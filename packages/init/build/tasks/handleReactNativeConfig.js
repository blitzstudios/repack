 ...
 */
export default function handleReactNativeConfig(cwd) {
    ...
    if (!configContent.includes('commands:')) {
        updatedConfigContent = configContent.replace('module.exports = {', "module.exports = {\n  commands: require('@callstack/repack/commands'),");
    }
    else {
        ...
        logger.warn("Replacing 'commands' in react-native.config.js with Re.Pack's commands");
        updatedConfigContent = configContent.replace(commandsString, newCommandsString);
    }
