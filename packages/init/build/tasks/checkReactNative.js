 ...
 */
export default function checkReactNative(rootDir) {
    ...
    if (semver.minor(version) < 69) {
        ...
        logger.warn('You can still use Re.Pack with older versions of React-Native, but you might encounter some issues.');
    }
    return version;
}
